...
public class Sql2oCandidatesRepositoryTest {
    ...
    public static void initRepositories() throws Exception {
        ...
        try (var inputStream = Sql2oCandidatesRepositoryTest.class.getClassLoader().getResourceAsStream("connection.properties")) {
    ...
    public void whenSaveThenGetSame() {
        ...
        var savedCandidate = sql2oCandidateRepository.findById(vacancy.getId()).get();
        assertThat(savedCandidate).usingRecursiveComparison().isEqualTo(vacancy);
    }
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedCandidate = new Candidate(
                candidate.getId(), "new name", "new description", creationDate.plusDays(0),
                 1, file.getId()
        );
    ...
    public void whenUpdateUnExistingCandidateThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = new Candidate(0, "title", "description", creationDate, 1, file.getId());
